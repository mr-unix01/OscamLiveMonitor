        ...
        Surface(
            ...
            if (connected) {
                androidx.compose.foundation.text.BasicTextField(
                    value = terminalOutput + terminalInput,
                    onValueChange = { nuovoTesto ->

                        /*
                         * Tutto ciò che OSCam/Linux ha già scritto
                         * resta intoccabile. Accettiamo come input
                         * soltanto ciò che viene digitato dopo.
                         */
                        if (!nuovoTesto.startsWith(terminalOutput)) {
                            return@BasicTextField
                        }

                        val nuovoInput =
                            nuovoTesto.removePrefix(terminalOutput)
